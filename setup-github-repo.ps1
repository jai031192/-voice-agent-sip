...
try {
    ...
    Write-Host "   - LIVEKIT_API_KEY: 108378f337bbab3ce4e944554bed555a" -ForegroundColor White
    Write-Host "   - LIVEKIT_API_SECRET: 2098a695dcf3b99b4737cca8034b122fb86ca9f904c13be1089181c0acb7932d" -ForegroundColor White
